    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
     ...
     <div class="container">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">الاسم الاول</li>
            <li class="list-group-item">الاسم الاخير </li>
            <li class="list-group-item">البريد الالكتروني</li>
...
<div class="loader-con">
    <div id="loader">
	    <canvas id="circularLoader" width="100" height="100"></canvas>
    </div>
</div>
